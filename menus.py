...
def main_menu():
    ...
    if selected == 0:
        ...
        # M�me si �a se coupe tout seul, par principe on �teint la musique.
...
def options_menu():
    ...
    dirty.append(screen.blit(load_image('Geryda Logo.png'), (8, 430)))
    dirty.append(screen.blit(load_image('logo-pygame.gif'), (506, 415)))
...
def credits():
    ...
    lines = ("Code originally from game 'Pydza' (sourceforge.net).",
             "Some graphics from kenney.nl; ",
             "flop pastry graphic and flopstand graphic by Aaron VonDerheide.",
             "~~~~~", "Pydza is in the public domain...", 
                "Level designers for :",
                 ...
                 "        Aldair",
                 "~~~~~",
                 "Menu TODO: modifiy, probably with ThorPy, and ", "    add info on story of Flo and Flip, the Flop siblings...",
                 "Press ESC")
